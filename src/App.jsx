  ...
  return (
    ...
    <>
      <BrowserRouter   >
        ...
        <Routes>
          <Route
            path="/FILM-VAULT-PROJECT/FILM-VAULT-PROJECT/"
            element={
              <>
          ...
          />
          <Route path="FILM-VAULT-PROJECT/FILM-VAULT-PROJECT/WatchList/" element={< Watchlist Watchlist={watchlist} removefromwatchlist={removewatchlist} />} />
        </Routes>
      </BrowserRouter>
    </>
  );
